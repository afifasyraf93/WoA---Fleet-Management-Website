const FleetPage = (() => {
  ...
  function card(a) {
    return `<div class="card" data-id="${a.id}" style="padding:0;overflow:hidden">
      ${Images.aircraftCardImg(a.icao, a.size, a.type, '130px')}
  ...
  function detail(a) {
    return `<div class="detail-grid">
      <div class="di"><div class="dl">ICAO</div><div class="dd">${a.icao}</div></div>
      <div class="di"><div class="dl">Name</div><div class="dd">${a.name}</div></div>
      <div class="di"><div class="dl">Manufacturer</div><div class="dd">${a.manufacturer||'—'}</div></div>
      <div class="di"><div class="dl">Size / Type</div><div class="dd">${a.size} / ${a.type}</div></div>
      <div class="di"><div class="dl">Generation</div><div class="dd">${a.gen||'—'}</div></div>
      ...
      <div class="di full"><div class="dl">Route</div><div class="dd">${a.route||'—'}</div></div>
      <div class="di"><div class="dl">Stand Type</div><div class="dd">${a.standType||'—'}</div></div>
      ${a.notes?`<div class="di full"><div class="dl">Notes</div><div class="detail-note">${a.notes}</div></div>`:''}
